...
docker-compose exec kafka kafka-topics --create --topic process_patient --partitions 1 --replication-factor 1 --if-not-exists --zookeeper zookeeper:32181

docker-compose exec kafka kafka-topics --create --topic query_patient --partitions 1 --replication-factor 1 --if-not-exists --zookeeper zookeeper:32181

...
all_joined2 = pd.read_csv(data + "model2_to_score.csv")
scoreddf=pd.read_csv(data + "scored_model2.csv")
...
scored_resp["PATHWAY"] = "DNA replication"
scored_resp['MODEL'] = 'AERO_DIGESTIVE_TRACT'
...
scored_resp.to_csv(data + "complete_score2.csv", header = False, na_rep = 'None', index=False)
